...
public class Admin extends UserRole implements Serializable
{
  ...
  public Game addGame(String aName, int aNrBlocksPerLevel, Ball aBall, Paddle aPaddle, Block223 aBlock223, HallOfFame aHallOfFame)
  {
    return new Game(aName, aNrBlocksPerLevel, this, aBall, aPaddle, aBlock223, aHallOfFame);
  }
